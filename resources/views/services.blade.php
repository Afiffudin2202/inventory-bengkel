...
@section('content')
    <section id="services">
        ...
        <div class="deskripsi-services row m-3 justify-content-center">
            <p class="" data-aos="fade-zoom-in" data-aos-easing="ease-in-back" data-aos-delay="200"
                data-aos-offset="0">
                {{ $deskripsi }}</p>
        </div>
        <div class="row mx-0 my-0 p-3 justify-content-center">
            @foreach ($galeri as $galeri)
                <div class="col-lg-4 col-md-6 col-sm-12 col-xs-12" data-aos="zoom-in" data-aos-delay="300">
